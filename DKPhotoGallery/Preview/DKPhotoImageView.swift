...
//
//  Source: https://github.com/patrickbdev/PBImageView/blob/master/PBImageView/Classes/PBImageView.swift
//

import UIKit
import FLAnimatedImage

open class DKPhotoImageView: UIView {
    ...
    open var animatedImage: FLAnimatedImage? {
        get { return self.imageView.animatedImage }
        set { self.imageView.animatedImage = newValue }
    }
