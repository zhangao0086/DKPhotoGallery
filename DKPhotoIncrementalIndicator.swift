...
public class DKPhotoIncrementalIndicator: UIView {
    ...
    public class func indicator(with direction: DKPhotoIncrementalIndicatorDirection, refreshBlock: @escaping (() -> Void)) -> DKPhotoIncrementalIndicator {
        switch direction {
        case .left:
